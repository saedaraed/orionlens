...
const FooterWithContact: React.FC<SectionProps> = ({ id }) => {
  ...
  return (
    <footer
      id={id}
      ref={ref}
      className="relative text-cairo bg-black text-white mt-[100px] z-100 "
    >
      <div className=" w-full flex justify-center mb-[-200px]">
        <motion.div className="container w-[90%] mx-auto flex flex-col md:flex-row  shadow-2xl rounded-lg overflow-hidden">
          {/* Left: Contact Info */}
          <motion.div
            className="w-full md:w-1/2 p-8  text-black font-cairo "
          ...
          >
            ...
            <p className="flex gap-4 mb-6 text-[20px] text-white/80">
              <svg
                ...
                className="text-heading fill-current"
              >
                <path
          ...
          {/* Right: Contact Form */}
          <motion.div
            className="w-full md:w-1/2 p-8 bg-black shadow-white-soft text-white m-0 md:m-4 h-[553px]"
            initial={{ opacity: 0, y: 50 }}
            animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
      ...
      {/* Footer Main Content */}
      <motion.div
        className=" mx-auto  px-6 pt-10 pb-10 bg-[#1A1A1A] mt-6"
        initial={{ opacity: 0, y: 50 }}
        animate={isInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
        transition={{ delay: 1.6, duration: 0.8, ease: "easeOut" }}
      >
        <div className=" container w-[90%] mx-auto md:mt-0 mt-40">
          <h2 className="text-[25px] font-bold mb-2 text-heading  font-cairo">
            Orion <span className="text-white">Lens</span>
          </h2>
          <p className="text-white/80 text-[20px] md:w-[40%] w-full font-cairo">
        ...
        <div className="container mx-auto  mt-[100px]">
          {/* Site Links */}
          <div>
            <ul className="flex md:flex-row flex-col justify-center gap-10 text-white/80">
              <li>
      ...
      <motion.div
        ...
        className="container w-[90%] mx-auto py-6 px-4 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left font-cairo text-sm text-white/80"
      >
